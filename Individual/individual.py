...
class Individual:
    ...
    def __init__(self, Pi: float, Ri: float, n: int, X_init = 0):
        ...
        assert 0 == X_init or X_init == 1 == True
        self.Pi = Pi  #breakdown probability
        self.Ri = Ri  #repair probability
        self.n = n  #number of slot
        self.x_n = X_init  #state of x
        # self.T = 0  #finished time slot
        # self.m_p = 0 #finished products
        # self.m_c = 0 #consumed materials
    ...
    # def get_Prate(self): #give the rate
    #     Pr = self.m_p/self.T
    #     return Pr

    # def get_Crate(self): #give the rate
    #     Cr = self.m_c/self.T
    #     return Cr