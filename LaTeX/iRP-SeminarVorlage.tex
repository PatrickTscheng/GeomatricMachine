...
emph={Individual,__init__, range, run_once, blockage, starvation, b_and_s, buffer_change, Buffer, check_null, check_full, add_one, take_one, get_measure,  MultiMachine, one_slot,calculation,procedure1},          % Custom highlighting
